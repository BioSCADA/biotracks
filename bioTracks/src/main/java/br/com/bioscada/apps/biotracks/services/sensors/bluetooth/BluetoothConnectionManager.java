...
public class BluetoothConnectionManager {
  ...
  private Sensor.SensorState sensorState;
  ...
  public BluetoothConnectionManager(
    ...
    this.sensorState = Sensor.SensorState.NONE;
  }

  /**
   * Gets the sensor state.
   */
  public synchronized Sensor.SensorState getSensorState() {
    return sensorState;
  }
