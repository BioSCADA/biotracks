...
public class LeHrmSensor extends BluetoothLeSensor {
  ...
  public java.util.UUID getServiceUuid() {
    return java.util.UUID.fromString(UUID.HEART_RATE_UUID);
  }

  @Override
  public java.util.UUID getMeasurementUuid() {
    return java.util.UUID.fromString(UUID.HEART_RATE_MEASUREMENT_UUID);
  }
