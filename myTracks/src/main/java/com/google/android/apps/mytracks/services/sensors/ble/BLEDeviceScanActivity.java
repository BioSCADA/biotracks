...
public class BLEDeviceScanActivity extends ListActivity {
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    if (!mScanning) {
      ...
      menu.findItem(R.id.ble_scan_scan).setVisible(true);
      menu.findItem(R.id.ble_scan_refresh).setActionView(null);
    } else {
      menu.findItem(R.id.ble_scan_stop).setVisible(true);
      menu.findItem(R.id.ble_scan_scan).setVisible(false);
      menu.findItem(R.id.ble_scan_refresh)
          .setActionView(R.layout.indeterminate_progress);
    }
    menu.findItem(R.id.ble_scan_clear).setVisible(true);
    return true;
  }
  ...
  private class LeDeviceListAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
      ...
      if (deviceName != null && deviceName.length() > 0)
        ...
        viewHolder.deviceName.setText(R.string.ble_scanning_unknown_device);
