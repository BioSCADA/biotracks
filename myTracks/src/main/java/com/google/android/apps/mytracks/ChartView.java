...
public class ChartView extends View {
  ...
  public ChartView(Context context) {
    ...
    series[ATTENTION_SERIES] = new ChartValueSeries(context,
        ...
        Integer.MAX_VALUE,
        new int[] {1, 2, 5, 10, 15, 20, 30, 60, 120},
        R.string.description_sensor_attention,
        R.string.description_sensor_attention,
        R.color.chart_attention_fill,
        R.color.chart_attention_border);
    series[MEDITATION_SERIES] = new ChartValueSeries(context,
        0,
        Integer.MAX_VALUE,
        new int[] {1, 2, 5, 10, 15, 20, 30, 60, 120 },
        R.string.description_sensor_meditation,
        R.string.description_sensor_meditation,
        R.color.chart_meditation_fill,
        R.color.chart_meditation_border);
