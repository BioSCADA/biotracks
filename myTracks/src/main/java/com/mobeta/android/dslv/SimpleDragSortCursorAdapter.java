...
public class SimpleDragSortCursorAdapter extends ResourceDragSortCursorAdapter {
     ...
     * @see android.support.v4.widget.SimpleCursorAdapter#setViewImage(android.widget.ImageView, String)
     * @see android.support.v4.widget.SimpleCursorAdapter#setViewText(android.widget.TextView, String)
     */
