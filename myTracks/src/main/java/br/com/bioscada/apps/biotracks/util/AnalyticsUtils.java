...
public class AnalyticsUtils {
  ...
  public static final String SENSOR_BTLE = "/sensor/btle";

  public static final String SENSOR_NEUROSKY = "/sensor/neurosky";

  private static final String UA = "UA-5156382-23";
  private static final String PRODUCT_NAME = "br.com.bioscada.apps.biotracks";
