...
package br.com.bioscada.apps.biotracks.io.file.importer;
...
abstract class AbstractFileTrackImporter extends DefaultHandler implements TrackImporter {
   ...
   */
  protected void addWaypoint(Waypoint.WaypointType type) throws SAXException {
  ...
  private void insertFirstWaypoint(Track track) {
    ...
    Waypoint waypoint = new Waypoint(waypointName, waypointDescription, waypointCategory, icon,
        track.getId(), Waypoint.WaypointType.STATISTICS, length, duration, -1L, -1L, waypointLocation,
        tripStatistics, "");
