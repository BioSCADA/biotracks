...
package br.com.bioscada.apps.biotracks.services.sensors.ant;

import br.com.bioscada.apps.biotracks.services.sensors.SensorValue;
import br.com.bioscada.apps.biotracks.services.sensors.ant.AntSensorManager.ChannelStates;
...
public abstract class ChannelConfiguration {
   ...
   */
  public abstract void decodeMessage(byte[] message, SensorValue antSensorValue);
